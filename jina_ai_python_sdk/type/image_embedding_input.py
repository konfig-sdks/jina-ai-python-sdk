...
class RequiredImageEmbeddingInput(TypedDict):
    ...
    input: typing.Union[typing.List[ImageDoc], ImageDoc]

class OptionalImageEmbeddingInput(TypedDict, total=False):
    # The format in which you want the embeddings to be returned.Possible value are `float` and `base64`. Defaults to `float`
    encoding_format: str

class ImageEmbeddingInput(RequiredImageEmbeddingInput, OptionalImageEmbeddingInput):
    pass
