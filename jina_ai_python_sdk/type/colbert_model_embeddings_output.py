...
from jina_ai_python_sdk.type.colbert_model_embeddings_output_data import ColbertModelEmbeddingsOutputData

class RequiredColbertModelEmbeddingsOutput(TypedDict):
    ...
    data: ColbertModelEmbeddingsOutputData

    # Total usage of the request. Sums up the usage from each individual input
    usage: ApiSchemasEmbeddingUsage

class OptionalColbertModelEmbeddingsOutput(TypedDict, total=False):
    object: str

class ColbertModelEmbeddingsOutput(RequiredColbertModelEmbeddingsOutput, OptionalColbertModelEmbeddingsOutput):
    pass
