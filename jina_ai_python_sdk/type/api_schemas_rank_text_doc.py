...
class RequiredApiSchemasRankTextDoc(TypedDict):
    text: str

class OptionalApiSchemasRankTextDoc(TypedDict, total=False):
...
class ApiSchemasRankTextDoc(RequiredApiSchemasRankTextDoc, OptionalApiSchemasRankTextDoc):
    pass
