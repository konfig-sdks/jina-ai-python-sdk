...
class RequiredApiSchemasMultiEmbeddingsTextEmbeddingInput(TypedDict):
...
class OptionalApiSchemasMultiEmbeddingsTextEmbeddingInput(TypedDict, total=False):
...
class ApiSchemasMultiEmbeddingsTextEmbeddingInput(RequiredApiSchemasMultiEmbeddingsTextEmbeddingInput, OptionalApiSchemasMultiEmbeddingsTextEmbeddingInput):
    pass
