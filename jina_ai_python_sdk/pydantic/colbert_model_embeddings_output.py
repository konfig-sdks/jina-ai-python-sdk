...
from jina_ai_python_sdk.pydantic.colbert_model_embeddings_output_data import ColbertModelEmbeddingsOutputData

class ColbertModelEmbeddingsOutput(BaseModel):
    ...
    data: ColbertModelEmbeddingsOutputData = Field(alias='data')
